...
from .views import WalletDetailView, TransactionListView, AwardCoinsView, LeaderboardView, GoalListView, GoalDetailView, TradeStockView, TransferCoinsView, CardDetailView
...
urlpatterns = [
    ...
    path('trade/', TradeStockView.as_view(), name='trade-stock'),
    path('transfer/', TransferCoinsView.as_view(), name='transfer-coins'),
    path('card-details/', CardDetailView.as_view(), name='card-details'),
]
