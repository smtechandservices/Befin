        ...
        <div className="min-h-screen flex text-foreground bg-gradient-to-br from-[#1C7CFF] to-[#0055D4]">
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
                <div className="w-full max-w-lg bg-white rounded-[2.5rem] p-10 md:p-14 shadow-2xl text-gray-900 mx-auto">
                    <div className="mb-8">
                        <p className="text-gray-500 mb-1">Welcome to <span className="text-[#0084ff] font-bold uppercase">BeFin</span></p>
                        <h2 className="text-[2.75rem] font-medium text-black tracking-tight mb-8">Sign in</h2>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-800 mb-2">Enter your username or email address</label>
                            <input
                                type="text"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-800 mb-2">Enter your Password</label>
                            <input
                                type="password"
                                required
                                className="w-full bg-white border border-[#BDE0FF] rounded-xl px-4 py-3.5 outline-none focus:border-[#0084ff] focus:ring-1 focus:ring-[#0084ff] transition-all text-gray-900 placeholder:text-gray-400"
                            ...
                            <div className="flex justify-end mt-3">
                                <button type="button" className="text-[13px] font-medium text-[#0084ff] hover:underline">Forgot Password</button>
                            </div>
                        </div>
                    ...
                    <p className="text-center text-gray-500 mt-8 text-sm">
                        Don't have an account ? <Link href="/signup" className="text-[#0084ff] font-medium hover:underline">Sign up</Link>
                    </p>
                </div>
            </div>
        </div>
